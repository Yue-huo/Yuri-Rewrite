...
- R3_CAUSAL_TRANSFORM / R3_DERIVED_TRANSFORM 只做契约要求的最小充分重构；R3_SURFACE_ADAPT 只做身份、称谓、身体或场景相关外貌适配；R3_PRESERVE 除全局姓名/代词映射外保留原句语义和中性词。若同时含 R3_RESTORE_SOURCE，逐项删除当前稿新增内容并恢复原文中性表达，不得再添加替代性润色。
